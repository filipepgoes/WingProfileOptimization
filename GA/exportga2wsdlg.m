...
%   $Revision: 1.18.4.5 $  $Date: 2005/06/21 19:21:31 $
...
%Retrieve problem
[fitnessFcn,nvars,aInEq,bInEq,aEq,bEq,lBnds,uBnds,nonlcon,randstate,randnstate] =  gaguiReadProblem(probmodel);
...
set(okButton, 'Callback', {@OKCallback, hDialog, checkBoxes, editFields, ...
                           ...
                           nvars,lBnds, uBnds, aInEq,bInEq, aEq, bEq,nonlcon, ...
                           pop, scores, randstate, randnstate, randchoice});
...
function OKCallback(obj, eventdata, dialog, cb, e, model, x, fval, exitMessage,output, ...
    fitnessFcn,nvars,lBnds, uBnds, aInEq,bInEq, aEq, bEq,nonlcon,pop, scores, ...
...
function KeyPressCallback(obj, eventdata, dialog, cb, e, model, x, fval, ...
        exitMessage, output, fitnessFcn,nvars,lBnds, uBnds, aInEq,bInEq, ...
        aEq, bEq,nonlcon,pop, scores, randstate,randnstate, randchoice)
    ...
    if ~isempty(asciiVal)
        ...
        if (asciiVal==32 || asciiVal==13)   
            OKCallback(obj, eventdata, dialog, cb, e, model, x, fval, ...
               exitMessage, output, fitnessFcn, nvars,nvars,lBnds, uBnds, ...
               aInEq,bInEq, aEq, bEq,nonlcon, pop, scores, randstate, ...
