...
%   $Revision: 1.23.4.4 $  $Date: 2005/06/21 19:21:39 $
...
[fitnessFcn,genomeLength,aineq,bineq,aeq,beq,LB,UB,nonlcon,randstate,randnstate,errP] = gaguiReadProblem(hproblem);
...
try
[x,fval,e,output,population,scores] = ga(fitnessFcn, genomeLength,aineq,bineq,aeq,beq,LB,UB,nonlcon,options);
gaResults.x = x; 
gaResults.fval = fval; 
gaResults.reason = e; 
