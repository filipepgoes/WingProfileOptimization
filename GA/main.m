...
aux1 = repmat((max-min)',pop,1);
aux2 = rand(pop,dims);
for i=1:dims
    for j=1:pop
        aux3(j,i) = aux1(j,i)*aux2(j,i);
    end
end
Seed=repmat(min',pop,1)+aux3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%OTIMIZAÇÃO%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
options=gaoptimset('PopulationSize',pop,'StallTimeLimit',2000,'StallGenLimit',35,...
    'Generations',gen,'InitialPopulation',Seed);
[x,fval,exitFlag,output,population,scores]=ga_filipe(@optimization_function,dims,[],[],[],[],min,max,[],options)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%RESULTADOS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Root airfoil
