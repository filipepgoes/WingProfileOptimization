...
%   $Revision: 1.19.4.5 $  $Date: 2005/06/21 19:21:32 $
...
%Retrieve problem 
[objFunction,startPoint,aInEq,bInEq,aEq,bEq,lBnds,uBnds,nonlcon,randstate,randnstate] = psguiReadProblem(probmodel);
...
set(okButton, 'Callback', {@OKCallback, hDialog, checkBoxes, editFields, ...
                           ...
                           bInEq, aEq, bEq, nonlcon, randstate, randnstate, randchoice});
...
function OKCallback(obj, eventdata, dialog, cb, e, model, x, fval, exitmessage,output, ...
                    ...
                    nonlcon, randstate, randnstate, randchoice)
    CB_PROBLEM = 1;
    CB_OPTION = 3;
    CB_RESTART = 2;
    CB_RESULTS = 4;
    ...
    if ~isempty(asciiVal)
        ...
        if (asciiVal==32 || asciiVal==13)   
            OKCallback(obj, eventdata, dialog, cb, e, model, x, fval, ...
                ...
                uBnds, aInEq, bInEq, aEq, bEq, nonlcon, randstate, randnstate, ...
                randchoice); 
