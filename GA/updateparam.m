function [MeshSize,MeshContraction,how,deltaX,deltaF,scale,Iterate,X,Iter,infMessage] = ...
         updateparam(pollmethod,successPoll,successSearch,MeshAccelerator,RotatePattern,MaxMeshSize,minMesh,MeshExpansion, ...
...
%   $Revision: 1.11.4.2 $  $Date: 2005/05/31 16:30:26 $
%   Rakesh Kumar

how = '';
factor = 1e-2;
Contract = MeshContraction;
