function [fun,X0,Aineq,Bineq,Aeq,Beq,LB,UB,nonlcon,randstate,randnstate, err] =  psguiReadProblem(h)
%private to psguirun, exportps2ws psguigeneratemfile

%   Copyright 2003-2005 The MathWorks, Inc.
%   $Revision: 1.3.4.2 $  $Date: 2005/05/31 16:30:15 $
...
fun = problem.objective; X0 = problem.X0; Aineq = problem.Aineq; 
Bineq = problem.Bineq; Aeq = problem.Aeq; Beq = problem.Beq; 
